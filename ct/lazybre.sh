#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/afflitto/ProxmoxVE/main/misc/build.func)
# Copyright (c) 2021-2025 tteck
# Author: tteck (tteckster) | Co-Author: remz1337 | Co-Author: MountyMapleSyrup (MountyMapleSyrup)
# License: MIT | https://github.com/community-scripts/ProxmoxVE/raw/main/LICENSE
# Source: https://github.com/janeczku/calibre-web | https://gitlab.com/LazyLibrarian/LazyLibrarian
...
function update_script() {
  ...
  msg_info "Stopping Calibre"
  systemctl stop cps
  msg_ok "Calibre Stopped"

  msg_info "Updating LazyLibrarian LXC"
  ...
  msg_info "Starting Calibre"
  systemctl start cps
  msg_ok "Started Calibre"
